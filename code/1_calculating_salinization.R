...
# Comparison to threshold of 1mS/cm
# Percentage of reaches with salinization > 1mS/cm
sum(salinization_km$salinization >= 1000)/nrow(salinization_km) * 100 
# Total length of reaches with salinization > 1mS/cm
with(salinization_km, sum(LENGTH_KM[salinization >= 1000]))
# Percentage of reaches with salinity > 1mS/cm
sum(salinization_km$EC >= 1000)/nrow(salinization_km) * 100 
# Total length of reaches with salinity > 1mS/cm
with(salinization_km, sum(LENGTH_KM[EC >= 1000]))
